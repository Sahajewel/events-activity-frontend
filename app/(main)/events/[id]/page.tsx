...
// import { useCreateBooking } from "@/types/useBooking";
...
export default function EventDetailsPage() {
  ...
  const handleJoinEvent = async () => {
    ...
    try {
      const response = await createBooking.mutateAsync(eventId);
      const bookingId = response.data.id;

      // If event has a fee, show payment dialog
                    ...
                    <div className="space-y-2">
                      ...
                      {userBooking?.status === "PENDING" && (
                        <Button
                          ...
                          className="w-full"
                          onClick={() => {
                            setPendingBookingId(userBooking.id);
                            setShowPaymentDialog(true);
                          }}
                        >
                          Complete Payment
